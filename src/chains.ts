...
export const chains: { [chainId: string]: IChain } = {
  "1": {
...
export const chainStatusInfo: { [status in ChainStatus]: ChainStatusInfo } = {
  [ChainStatus.SUPPORTED]: {
    title: "Supported",
    description: "Host deployed and live in the chain",
    color: "#4ade80", // green-400
    bgColor: "#00521f",
  },
  [ChainStatus.DEVELOPMENT]: {
    title: "Development",
    description: "Chain integration being developed",
    color: "#60a5fa", // blue-400
    bgColor: "#1d3f6c",
  },
  [ChainStatus.NOT_SUPPORTED]: {
    title: "Not supported",
    description: "Host know this chain but not have deployments on it",
    color: "#eeeeee",
    bgColor: "#2c2c2c",
  },
};
...
export const getChainByName = (chainName: ChainName): IChain => {
